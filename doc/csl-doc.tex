...
The \pkg{csl} package is aimed to provide another reference system for LaTeX
that utilizes the CSL styles.
It contains a citation processor implemented in Lua (\pkg{citeproc-lua})
...
The general procedure is as follows, similar to the traditional BibTeX
workflow.
\begin{enumerate}
